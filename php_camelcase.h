...
#define PHP_CAMELCASE_VERSION "0.1.0" /* Replace with version number for your extension */
...
PHP_FUNCTION(confirm_camelcase_compiled);	/* For testing, remove later. */

/* 
  	Declare any global variables you may need between the BEGIN
	and END macros here:     

ZEND_BEGIN_MODULE_GLOBALS(camelcase)
	long  global_value;
	char *global_string;
ZEND_END_MODULE_GLOBALS(camelcase)
*/

/* In every utility function you add that needs to use variables 
   in php_camelcase_globals, call TSRMLS_FETCH(); after declaring other 
   variables used by that function, or better yet, pass in TSRMLS_CC
   after the last function argument and declare your utility function
   with TSRMLS_DC after the last declared argument.  Always refer to
   the globals in your function as CAMELCASE_G(variable).  You are 
